...
- **Key type:** AT Proto DIDs use Ed25519 keys — which is also what the provenance layer signs with (`04`). One crypto stack for both identity and provenance; no second key system. This was a stated reason to lean on AT Proto (Tech Chat 2).
