...
class SweepDeterminismTest {
    ...
    private static SoloSave equipped(long seed) {
        SoloSave save = NetTestKit.world(seed);
    ...
    class Sensitivity {
        ...
        void unownedTiersRefuse() {
            SoloSave save = NetTestKit.world(seed(9));
            long free = io.github.stoicswe.eyeandsickle.solo.rules.ComputeRules.availableCycles(save.rig);
    ...
    class Position {
        ...
        void positionSubstitutesForReach() {
            ...
            SoloSave save = NetTestKit.world(seed(21));
            SweepReport first = NetTestKit.sweep(save, SweepTier.BASE, NetTestKit.T0);
            assertThat(first.found()).isPositive();
        ...
        void connectNeedsAFoothold() {
            SoloSave save = NetTestKit.world(seed(22));
        ...
        void theSchematicIsTheOnlyThingThatMovesReach() {
            SoloSave withoutMapper = NetTestKit.world(seed(31));
            SoloSave withMapper = NetTestKit.world(seed(31));
            ...
            assertThat(far.foundAddresses()).containsAll(near.foundAddresses());
