 ...
 * from a lost bot; this one drops it from a breach. Both pay into {@link SoloSave#schematicMaterial}
 ...
 * looks at how many rows {@link SoloSave#resolutions} holds. Counting is what count-gating is, and
...
public final class SalvageRules {
     ...
     */
    public static int award(SoloSave save, ResolutionState record) {
        if (record == null) {
            return 0;
        }
    ...
    public static int remainingForUnlock(SoloSave save) {
