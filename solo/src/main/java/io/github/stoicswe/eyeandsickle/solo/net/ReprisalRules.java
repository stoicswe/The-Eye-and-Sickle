...
import io.github.stoicswe.eyeandsickle.solo.rules.AccessLog;
...
public final class ReprisalRules {
     ...
     */
    public static Reprisal answer(SoloSave save, HostState host, Rng rng, Instant now) {
     ...
     */
    private static Reprisal steal(SoloSave save, String from, Instant now) {
     ...
     */
    private static Reprisal plant(SoloSave save, String from, Rng rng, Instant now) {
    ...
    public static List<MinerState> squatters(SoloSave save) {
