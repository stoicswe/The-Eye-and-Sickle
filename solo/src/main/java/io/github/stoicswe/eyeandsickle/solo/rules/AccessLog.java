...
import io.github.stoicswe.eyeandsickle.solo.state.AccessEntry;
...
public final class AccessLog {
     ...
     */
    public static int redact(SoloSave save, String fromAddress) {
    ...
    public static List<String> attackers(SoloSave save) {
        if (save == null) {
            return List.of();
        }
     ...
     */
    public static List<String> render(SoloSave save) {
    ...
    public static int size(SoloSave save) {
        return save == null || save.remoteAccessLog == null ? 0 : save.remoteAccessLog.size();
    }

    private static long nextSequence(SoloSave save) {
