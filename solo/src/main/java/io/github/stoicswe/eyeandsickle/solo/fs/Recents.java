...
import io.github.stoicswe.eyeandsickle.solo.state.RecentEntry;
...
public final class Recents {
     ...
     */
    public static void record(SoloSave save, String path, boolean directory, Instant now) {
    ...
    /** Most recent first. */
    public static List<RecentEntry> entries(SoloSave save) {
