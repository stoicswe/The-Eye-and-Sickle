...
public final class PortScanRules {
     ...
     */
    public static Started begin(SoloSave save, String address, PortScanTarget target, Instant now) {
    ...
    public static Optional<TaskState> running(SoloSave save, String address) {
        if (save == null) {
     ...
     */
    public static PortScanReport settle(SoloSave save, TaskState task, Rng rng, Instant now) {
    ...
    private static Optional<HostState> hostAt(SoloSave save, String address) {
