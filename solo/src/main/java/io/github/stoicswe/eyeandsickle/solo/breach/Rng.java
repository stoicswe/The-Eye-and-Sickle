 ...
 * what lets {@code SoloGameTest} assert exact ethecoin figures and what makes a bug reproducible
 ...
 * {@link #commit(SoloSave)} before it returns.</b> Uncommitted draws advance a local counter and
...
public final class Rng {
    ...
    public static Rng of(SoloSave save) {
     ...
     */
    public void commit(SoloSave save) {
        save.rngSeed = state;
    }
